...
/**
 * A simple test implementation of the TestContext interface.
 * Default values are stubbed out, and setters are provided so you can customize
 * the context before passing it to the function.
 */
